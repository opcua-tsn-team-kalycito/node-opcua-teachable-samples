...
const server_certificate_file = constructFilename("./certificates/server_selfsigned_cert_1024.pem");
...
(async function main() {
    try {
        ...
        const client_certificate_file = constructFilename("./certificates/client_selfsigned_cert_1024.pem");
